<h1 align="center">
  <a href="https://github.com/chavyleung/scripts#boxjs">🧰</a>
  BoxJs
</h1>

<h4 align="center">A SPA Appliction be used for scripts utils</h4>
...
### 2. 安装链接
>**boxjs.rewrite.surge :** https://raw.githubusercontent.com/chavyleung/scripts/master/box/rewrite/boxjs.rewrite.surge.sgmodule

### 3. 安装方式
>Surge首页 -> 通用 -> 模块 -> 安装新模块... -> 复制粘贴上方的安装链接 -> 完成......

### 4. 使用方式
>安装模块后，浏览器访问[boxjs.com](http://boxjs.com "BoxJs")
